	...
	<div class="container-fluid">
     <div class="row">
		<?php
         ...
         ?>
         	<div class="col-12">
         		<h2 class="text-center text-capitalize pt-5 pb-5" style="font-family: 'Helvetica', serif;">No Products are Selected</h2>
         	</div>
         <?php
     	}
         	else{
         ...
         <div class="col-sm-3 mb-4">
            <div class="card-mb-3" style="width:20rem;">
                ...
                <div class="card-body">
                     ...
                     <p class="card-text">
                        <h4>Quantity:<?php echo $rows['Quantity']?><br></h4>
                        	<h2>Rs.<?php echo $rows['Price']?></h2>
                    </p>
                </div>
              </div>
         </div>
