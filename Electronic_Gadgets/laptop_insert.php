...
<body>
	<form class="form-inline" action="laptop_insert.php" method="post" enctype="multipart/form-data">
	...
	<input type="text" name="height" id="height" class="form-control" placeholder="Enter height in inches"  required></br>
